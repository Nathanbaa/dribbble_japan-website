...
window.addEventListener("DOMContentLoaded",() => {
    ...
    if(script.getAttribute("color") !== null){
        ...
        if(script.getAttribute("difference") == "disable"){
            iDiv.style.backgroundColor = "#333333"
        } else {
    ...
    if(script.getAttribute("color") !== null){
        ...
        if(script.getAttribute("difference") == "disable"){
            innerDiv.style.backgroundColor = "#333333"
        } else {
            innerDiv.style.backgroundColor = "brown"
        }
    }
      iDiv.appendChild(innerDiv);
    }
            ...
            if(script.getAttribute("mscursor-circle-outline") !== "disable"){
                ...
                if(script.getAttribute("color") !== null){
                    ...
                    if(script.getAttribute("color-outline") !== null){
                        ...
                        if(script.getAttribute("difference") == "disable"){
                            document.querySelector("div.new").style.border= `0.5px solid #333333`
                        } else {
